...
# Nginx config file
template node['nginx']['dir'] + "/sites-available/etherpad.conf" do
    ...
    variables({
      ...
      :ssl_cert => node['etherpad-lite']['ssl_cert'],
      :ssl_key => node['etherpad-lite']['ssl_key'],
      :ssl_enabled => node['etherpad-lite']['ssl_enabled'],
...
link node['nginx']['dir'] + "/sites-enabled/45-etherpad.conf" do
  to node['nginx']['dir'] + "/sites-available/etherpad.conf"
end
